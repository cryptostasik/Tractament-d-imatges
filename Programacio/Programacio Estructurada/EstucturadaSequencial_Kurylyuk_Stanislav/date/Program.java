...
public class Program {
    ...
    public static boolean isDate(int year, int day, int month) {
		// Determine if the year is a leap year: divisible by 400 or divisible by 4 but not by 100
		boolean isLeapYear = (year % 400 == 0) || (year % 4 == 0 && year % 100 != 0);
		// Check if the month has 31 days (January, March, May, July, August, October, December) 
		// and the day is valid (between 1 and 31)
		boolean data31 = (month == 1 || month == 3 || month == 5 || month == 7 || month == 8 || month == 10 || month == 12) 
                && (day >= 1) && (day <= 31);
		// Check if the month has 30 days (April, June, September, November) 
		// and the day is valid (between 1 and 30)
		boolean data30 = (month == 4 || month == 6 || month == 9 || month == 11) 
                && (day >= 1) && (day <= 30);
		// Check if the month is February and the day is valid: 
		// - For a leap year, day must be between 1 and 29
		// - For a non-leap year, day must be between 1 and 28
